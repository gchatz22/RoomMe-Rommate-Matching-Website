...
function renderNavbar(user) {
  ...
  navbarDiv.appendChild(newNavbarItem('Home', '/feed', 'active'));

  if (user._id !== undefined) {
    navbarDiv.appendChild(newNavbarItem('Profile', '/viewprofile?'+user._id));
...
function renderNavbarResponsive(user) {
  ...
  dropdown.appendChild(newNavbarItemResponsive('Home', '/feed', 'active'));
